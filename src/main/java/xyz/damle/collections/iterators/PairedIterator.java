...
package xyz.damle.collections.iterators;
...
/**
 * Provides an iteration over the elements contained in a pair of Iterators.
 *
 * <p>Given two {@link Iterator} instances {@code A} and {@code B}, the {@link #next} method on this
...
public class PairedIterator<L, R> implements Iterator<PairedItem<L, R>> {
   ...
   * @since 4.5
   */
  public static <L, R> PairedIterator<L, R> of(
      Iterator<L> leftIterator, Iterator<R> rightIterator) {
   ...
   * @since 4.5
   */
  public static <L, R> PairedIterator<L, R> ofIterables(
   ...
   * @since 4.5
   */
  public record PairedItem<L, R>(L leftItem, R rightItem) {
